...
<tr>
<td>Date of Birth </td><td><input type="date" name="studentDoB" placeholder="YYYY-mm-dd"></td>
</tr>
<tr>
<td>ID</td><td><input type="number" name="studentID" placeholder="Students ID"></td>
</tr>
<tr>
